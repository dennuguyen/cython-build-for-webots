# Cython Build for Webots

## To Do

* Make sure to specify the path to your C++ files in the Makefile.
* Move your python code into `scripts/example.pyx`. Feel free to rename this file.
* [Cython tutorial](https://cython.readthedocs.io/en/latest/src/tutorial/cython_tutorial.html)
* [C++/Cython](https://cython.readthedocs.io/en/latest/src/userguide/wrapping_CPlusPlus.html)
* [Embedded Cython in C++ example](https://cython.readthedocs.io/en/latest/src/tutorial/embedding.html)
* Examples have been provided in the `controllers` folder and can be compiled with the following (for Linux):
    ```
    python3 setup.py build_ext
    ```
    ```
    g++ src/example.cpp -I./include -I../../python3.7/linux/include -L../../python3.7/linux/lib -l:libpython3.7m.so example_main.cpp -o example
    ```
